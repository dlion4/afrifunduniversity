                ...
                return Object.assign(
                    {
                        ...
                        init: function () {
                            ...
                            (this.categoryId || this.sectionId) && Util.get(["categories", "sections"], ["id", "category_id", "parent_section_id", "html_url", "name", "description", "position"]).then(this.getActiveCategory.bind(this));
                        },
                        getActiveCategory: function (a) {
                            if (this.categoryId) {
                                var b = this.categoryId;
                                this.category =
                                    a.categories.filter(function (a) {
                                        return a.id === b;
                                    })[0] || null;
                            } else if (this.sectionId) {
                                var c = this.sectionId,
                                    d =
                                        a.sections.filter(function (a) {
                                            return a.id === c;
                                        })[0] || null;
                                (this.parentSection =
                                    a.sections.filter(function (a) {
                                        return a.id === d.parent_section_id;
                                    })[0] || null),
                                    (this.category =
                                        a.categories.filter(function (a) {
                ...
                handleOverflow: function () {
                    var a = new IntersectionObserver((b) => {
                        for (var c of b) {
                            ...
                            0 > d.x && (this.$refs.menu.style.left = Math.abs(rect.left) + "px"),
                                d.x + d.width >= window.innerWidth && (this.$refs.menu.style.left = -(d.x + d.width - window.innerWidth) + "px"),
                                d.top + d.height >= window.innerHeight && ((this.$refs.menu.style.top = "auto"), (this.$refs.menu.style.bottom = "100%")),
            ...
            return Object.assign(
                {
                    ...
                    init: function () {
                        ...
                        this.isSticky && this.applyStickyHeader(),
                            this.isFixed && this.hasHeroElement() ? this.applyFixedHeader() : ((this.isFixed = !1), a.classList.remove("fixed-header")),
