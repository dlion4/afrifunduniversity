var OneTrustStub = (function (t) {
  ...
  var d = new(function () {
      ...
      (this.executeGppApi = function () {
        ...
        var i = null == (i = s.win)
          ? void 0
          : i.__gpp;
        if (((i.queue = i.queue || []), (i.events = i.events || []), !t.length || (1 === t.length && "queue" === t[0]))) 
          return i.queue;
      ...
      (this.addEventListener = function (t, e) {
        var i,
          n = s.win.__gpp;
        return ((n.events = n.events || []), (null != (i = n) && i.lastId) || (n.lastId = 0), n.lastId++, n.events.push({id: n.lastId, callback: t, parameter: e}), {
    ...
    m = ((h.prototype.initConsentSDK = function () {
      ...
      e && e.CookieV2BulkDomainManagement && i !== n && t.ScriptType === u && (
      ...
      if ((this.setDomainIfBulkDomainEnabled(t), this.updateVersion(t), ((t.TenantFeatures && t.TenantFeatures.CookieV2CSP) || t.CookieV2CSPEnabled) && this.nonce && ((this.setAttributePolyfillIsActive = !0), new n().implementThePolyfill()), !t.RuleSet[0].Type)) 
      ...
      return new RegExp("^file://", "i").test(e) && t.MobileSDK
        ? ((e = "/" + t.GeolocationUrl.replace(/^(http|https):\/\//, "").split("/").slice(1).join("/") + ".js"), p.storageBaseURL + e)
        : t.GeolocationUrl;
    ...
    (h.prototype.isBoolean = function (t) {
     ...
     (h.prototype.updateGtmMacros = function () {
      ...
      !this.otDataLayer.ignore && t.length && (o[this.otDataLayer.name].constructor === Array && o[this.otDataLayer.name].push({event: "OneTrustGroupsUpdated", OnetrustActiveGroups: a}), (n = new CustomEvent("OneTrustGroupsUpdated", {detail: t}))),
      setTimeout(function () {
    ...
    //       e
    //       ? t.split("/consent")
    //       : t.split("/scripttemplates/" + p.stubFileName))[0])),
  ...
  function h() {
    ...
    (this.addBannerSDKScript = function (t) {
      var e = s.getRegionSet(t),
        i = (
          ...
          s.iabTypeAdded && (("IAB2" !== e.Type && "IAB2V2" !== e.Type) ||
           ((s.iabType = e.Type), s.intializeIabStub()), "IAB2" !== e.Type) && "IAB2V2" !== e.Type && s.removeTcf(), 
           e.IsGPPEnabled
          ? d.init()
          : d.removeGppApi(),
    ...
    (this.receiveIabMessage = function (i) {
      ...
      e.__tcfapiCall && "IAB2" === s.iabType && ((n = e.__tcfapiCall.callId), (a = e.__tcfapiCall.command), (t = e.__tcfapiCall.parameter), (e = e.__tcfapiCall.version), s.executeTcfApi(a, t, function (t, e) {
        t = {
          __tcfapiReturn: {
            returnValue: t,
            success: e,
    ...
    (this.getPingRequest = function (t, e) {
      var i;
      void 0 === e && (e = !1),
      t && ((i = !(e = {})), ("IAB2" !== s.iabType && "IAB2V2" !== s.iabType) || ((e = {
