...
var chart_data   = [],
    datapoints='';
        ...
        function readTest(product,category,acad_year,base_url,inst){
                    //alert('yo');
                    //alert(product + '-' + category + '-' + acad_year);
                    //Declare variables
                    var url='',
                        action='';
                                                                    
                    url=base_url + "account/getCharts/" + $.trim(product) + '/' + $.trim(category) + '/' + acad_year 
                    + '/' + inst;
                    //alert(url);
                    ////////////////////////////////////////////////////////////////////        
                    $.ajax({
                            ...
                            require(
                                ...
                                function (ec) {
                                    ...
                                    ****************************************/
                                    // Initialize chart
                                    // ------------------------------
                                    $('#nightingale-rose-labels').remove(); // this is my <canvas> element
                                    $('#graph-container').append('<div id="nightingale-rose-labels" class="height-400 echart-container"></div>');
                                    $('#nightingale-rose-labels').empty();
                                    //$('#nightingale-rose-labels').empty();
