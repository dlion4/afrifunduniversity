...
LOCAL_APPS = [
    "afrifunduniversity.users",
    # Your stuff: custom apps go here
    "apps.loans",
    "apps.main_application",
    # For schools related application
    "apps.schools.school",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "apps.main_application.context_processor.client_help_contact_information",
            ],
        },
    },
]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Afri Fund University API",
    "DESCRIPTION": "Documentation of API endpoints of Afri Fund University",
    "VERSION": "1.0.0",
